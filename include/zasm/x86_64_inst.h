...
enum _x86_64_inst_type_ {
	...
	INST_REG_AH			= 0x100001,
	INST_REG_AL			= 0x100002,
	INST_REG_RCX		= 0x200000,
	INST_REG_CL			= 0x200001,
	INST_REG_SPECIFY	= 0xF00000,
#endif /* __x86_64__ */
	INST_ERR			= 0xFFFFFFFF,
};
...
#define USED_REGISTERS		"r8", "r9", "r10", "r11", "rax", "rcx", "rdx", "rbx"
