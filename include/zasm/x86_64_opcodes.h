...
INST_ASM_OP (mov, 0x8C, INST_REG_ALL | INST_MEM16,	INST_REG_SEGMEM,  INST_REG_OPERANDS | INST_REG_SWAP)
INST_ASM_OP (lea, 0x8D, INST_REG16_32_64,		INST_MEM | INST_SIZE_ALL,	INST_REG_OPERANDS)
INST_ASM_OP (mov, 0x8E, INST_REG_SEGMEM,		INST_REG16 | INST_MEM16,	INST_REG_OPERANDS | INST_REG_SWAP)
INST_ASM_OP0(nop, 0x90)
INST_ASM_OP0(cdq, 0x99)
INST_ASM_OP (cqo, 0x99, INST_NONE, INST_NONE, INST_EXTENSION_64)
INST_ASM_OP (mov, 0xB0, INST_REG8,				INST_IMM8,					INST_SECONDARY)
INST_ASM_OP (mov, 0xB8, INST_REG16_32_64,		INST_IMM16_32_64,			INST_SECONDARY)

INST_ASM_OP1(lodsb, 0xAC, INST_REG_AL)
INST_ASM_OP1(lodss, 0xAD, INST_REG_RAX | INST_REG_EAX | INST_REG_AX)
...
INST_ASM_OP1(ret, 0xC2, INST_IMM16)
...
INST_ASM_OP1(int,  0xCD, INST_IMM8)
...
INST_ASM_OP1(jmp,  0xEB, INST_IMM8)

INST_ASM_OP0(hlt,  0xF4)	/* Halt */
INST_ASM_OP0(cmc,  0xF5)	/* Complement Carry Bit */
...
INST_ASM_OP0(clc,  0xF8)	/* Clear Carry     Bit */
INST_ASM_OP0(stc,  0xF9)	/* Set   Carry     Bit */
INST_ASM_OP0(cli,  0xFA)	/* Clear Interrupt Bit*/
INST_ASM_OP0(sti,  0xFB)	/* Set   Interrupt Bit */
INST_ASM_OP0(cld,  0xFC)	/* Clear Direction Bit */
INST_ASM_OP0(std,  0xFD)	/* Set   Direction Bit */
...
INST_ASM_OP (inc,  0xFF, INST_REG16_32_64 | INST_MEM16_32, 		INST_NONE,	INST_OPCODE_EXT | 0x0)
INST_ASM_OP (dec,  0xFF, INST_REG16_32_64 | INST_MEM16_32, 		INST_NONE,	INST_OPCODE_EXT | 0x1)
INST_ASM_OP (call, 0xFF, INST_REG64 | INST_MEM64,				INST_NONE,	INST_OPCODE_EXT | 0x2)
INST_ASM_OP (jmp,  0xFF, INST_REG64 | INST_MEM64,				INST_NONE,	INST_OPCODE_EXT | 0x4)
